...
module.exports = {
    addCart: async(req,res)=>{
        ...
        try{
            ...
            if(cart){
                ...
                await cart.save();
                res.status(200).json('Product added correctly');
            }else{
    ...
    deleteCartItem: async(req,res)=>{
        ...
        try{
            ...
            if(!updatedCart) return res.status(404).json('Cart Item not Found');
    ...
    decrementCartItem: async(req,res)=>{
        ...
        try{
            ...
            if(!existingProduct) return res.status(404).json('Product not Fopund');
